...
<div class="container body">
    ...
    <div class="main_container">
        ...
        <!-- page content -->
        <div class="right_col" role="main" style="margin-left: 2%; width: 96%;">
            <div class="">

                <div class="row top_tiles" style="margin: 10px 0;">
                    <h3 style="color:#0000C2;">Olá seja bem vindo ao blog do João Lucas</h3>
                    <h2>
                        Esta página é a execução de uma tarefa requerida pelo curso de Laravel 5 Express <br/>
                        Aqui usamos um template para criação dessa pagina conforme a dica dada no presente curso. Que alias esta sendo muito proveitos.  
                    </h2>
                </div>
                <div class="row top_tiles" style="margin: 10px 0;">
